...
var ModuleName = 'personal/certificated';
    ...
    Page.prototype[ModuleName] = function() {
      ...
      var data = {}, amount = '';
        ...
        function getList(page) {
    			...
    			_this.fetch('/require/mjson/personal/certificate', data, function (res) {
    				if (res.code == 0) {
    					var amount = res.data.amount;
    					var listData = res.data;
    					var pages = Math.ceil(amount / data.limit); //得到总页数
    					$('#certificated_list_warp').html(T('certificated_list', {list: listData}));
              setTimeout(function(){
                layer.close(layerLoading)
              },500);
    					//显示分页
    					laypage({
    						cont: 'certificated_list_number',
    						pages: pages,
    						skin: 'yahei',
    						curr: page || 1, //当前页
