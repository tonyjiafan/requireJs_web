/**
 * @exports 'crypt.CryptoJS'
 * @author Robin
 */

define('crypt.CryptoJS', function() {
    'use strict';
    ...
    (function () {
        var b = CryptoJS, a = b.lib, f = a.Base, k = a.WordArray, a = b.algo, l = a.EvpKDF = f.extend({
            cfg: f.extend({
                keySize: 4,
                hasher: a.MD5,
                iterations: 1
                ...
                for (var c = this.cfg, d = c.hasher.create(), g = k.create(), f = g.words, h = c.keySize, c = c.iterations; f.length < h;) {
                    e && d.update(e);
